#!/usr/bin/env python3
"""Build focused flow-WM RMS alignment ablation manifests."""
...
RMS_PROFILES: List[RmsProfile] = [
    RmsProfile("flow_rms_off", []),
    RmsProfile("flow_rms_on", ["alg.rew_rms=true"]),
]
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build flow RMS alignment ablation manifest.")
    ...
    parser.add_argument("--stage", default="flow_rms_align")
