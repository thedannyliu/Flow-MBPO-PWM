#!/usr/bin/env python3
"""Export Phase 1.8 residual/chunked WM results to a compact CSV."""
...
def main() -> None:
    ...
    fieldnames = [
        ...
        "train_residual_norm_mean",
        "val_residual_norm_mean",
        ...
        "train_chunk_base_endpoint_dyn_loss_mean",
        "val_chunk_base_endpoint_dyn_loss_mean",
        "train_chunk_residual_norm_mean",
        "val_chunk_residual_norm_mean",
        "train_chunk_residual_contribution_mean",
        "val_chunk_residual_contribution_mean",
            ...
            writer.writerow(
                {
                    ...
                    "train_residual_norm_mean": mean([metric(x, "final_train", "residual_norm") for x in ds]),
                    "val_residual_norm_mean": mean([metric(x, "final_val", "residual_norm") for x in ds]),
                    ...
                    "train_chunk_base_endpoint_dyn_loss_mean": mean([metric(x, "final_train", "chunk_base_endpoint_dyn_loss") for x in ds]),
                    "val_chunk_base_endpoint_dyn_loss_mean": mean([metric(x, "final_val", "chunk_base_endpoint_dyn_loss") for x in ds]),
                    "train_chunk_residual_norm_mean": mean([metric(x, "final_train", "chunk_residual_norm") for x in ds]),
                    "val_chunk_residual_norm_mean": mean([metric(x, "final_val", "chunk_residual_norm") for x in ds]),
                    "train_chunk_residual_contribution_mean": mean([metric(x, "final_train", "chunk_residual_contribution") for x in ds]),
                    "val_chunk_residual_contribution_mean": mean([metric(x, "final_val", "chunk_residual_contribution") for x in ds]),
