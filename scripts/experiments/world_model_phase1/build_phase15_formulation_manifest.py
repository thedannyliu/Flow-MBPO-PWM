...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--wandb-project", default="flow-mbpo-phase15-wm-formulation-ablations")
...
def main() -> None:
    ...
    profiles = [
        ...
        {
            "method_key": "mlpwm_mlppolicy",
            "method_label": "Gaussian MLP WM",
            "profile": "mlp_probabilistic",
            "alg_config": "scripts/cfg/alg/pwm_5M_baseline_probabilistic.yaml",
        },
        {
            "method_key": "mlpwm_mlppolicy",
        ...
        {
            "method_key": "flowwm_mlppolicy",
            "method_label": "Flow PairWeight Gibbs",
            "profile": "flow_pairweight_gibbs",
            "alg_config": "scripts/cfg/alg/pwm_5M_flow_v2_substeps4_pairweight_gibbs.yaml",
        },
        {
            "method_key": "flowwm_mlppolicy",
        ...
        {
            "method_key": "flowwm_mlppolicy",
            "method_label": "Flow Target Hybrid",
            "profile": "flow_target_hybrid",
            "alg_config": "scripts/cfg/alg/pwm_5M_flow_v2_substeps4_target_hybrid.yaml",
        },
        {
            "method_key": "flowwm_mlppolicy",
            "method_label": "Flow WindowConsistency2",
            "profile": "flow_windowcons2",
            "alg_config": "scripts/cfg/alg/pwm_5M_flow_v2_substeps4_windowcons2.yaml",
        },
        {
            "method_key": "flowwm_mlppolicy",
            "method_label": "Flow WindowConsistency4",
            "profile": "flow_windowcons4",
            "alg_config": "scripts/cfg/alg/pwm_5M_flow_v2_substeps4_windowcons4.yaml",
        },
    ]

    stage = f"phase15_formulation_ablations_{args.mode}"
    rows = []
            ...
            rows.append(
                {
                    ...
                    "wandb_group": f"phase15_{args.mode}_{args.task_key}",
