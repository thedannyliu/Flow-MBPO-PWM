...
${ENV_DIR}/bin/python scripts/diagnostics/pwm_dflex_checkpoint_probe.py --checkpoint ${ROOT}/baselines/PWM/scripts/outputs/2026-06-01/20-27-50/logs/phase1_hopper_formal_locked_h200_s0_20260601/final_policy.pt --env dflex_hopper --checkpoint-mode full --policy actor --device cuda:0 --seed 0 --num-envs 64 --steps 128 --output eval_results/pwm_phase2_hopper_locked_probe_20260602/final_actor_wm_vs_real_fix4.json && \
${ENV_DIR}/bin/python scripts/diagnostics/pwm_dflex_checkpoint_probe.py --checkpoint ${ROOT}/baselines/PWM/scripts/outputs/2026-06-01/20-27-50/logs/phase1_hopper_formal_locked_h200_s0_20260601/best_policy.pt --env dflex_hopper --checkpoint-mode full --policy actor --device cuda:0 --seed 0 --num-envs 64 --steps 128 --output eval_results/pwm_phase2_hopper_locked_probe_20260602/best_actor_wm_vs_real_fix4.json"
