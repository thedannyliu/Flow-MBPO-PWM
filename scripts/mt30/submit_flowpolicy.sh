#!/bin/bash
#SBATCH --job-name=mt30_flowpolicy
#SBATCH --output=logs/slurm/mt30/flowpolicy_%j.out
#SBATCH --error=logs/slurm/mt30/flowpolicy_%j.err
...
# Policy-only comparison - isolates policy contribution
...
mkdir -p outputs/mt30/flowpolicy/seed${SEED}
