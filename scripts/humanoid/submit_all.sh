#!/bin/bash
# Submit all Humanoid training experiments
# WandB project: flow-mbpo-single-task-Humanoid
...
echo "==========================================="
echo "Submitting ALL Humanoid Training Experiments"
...
for SEED in "${SEEDS[@]}"; do
    JOB_NAME="humanoid_baseline_s${SEED}"
    RUN_NAME="Humanoid_Baseline_MLP_s${SEED}"
...
echo ""
echo "==========================================="
echo "All Humanoid experiments submitted!"
echo ""
echo "Summary:"
