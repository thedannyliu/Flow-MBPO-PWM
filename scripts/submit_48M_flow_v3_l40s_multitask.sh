#!/bin/bash
#SBATCH --job-name=train_mt30_flow_v3
...
#SBATCH --qos=embers
#SBATCH --output=/storage/project/r-agarg35-0/nnguyen349/logs/train_mt30_flow_v3_%j.out
#SBATCH --error=/storage/project/r-agarg35-0/nnguyen349/logs/train_mt30_flow_v3_%j.err
...
echo ""
echo "============================================"
echo "Training Flow-MBPO V3 48M Multi-task (MT30)"
echo "============================================"
echo "Method: Flow-matching world model"
echo "Config: use_flow=true, euler integrator, 8 substeps"
echo "============================================"
...
#   flow_integrator=euler: Uses Euler method (1st order, simpler)
#   flow_substeps=8: 8 integration substeps (high-fidelity)
#   exp_name=flowv3_48M_mt30: For wandb tracking
