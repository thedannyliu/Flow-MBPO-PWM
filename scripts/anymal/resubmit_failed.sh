#!/bin/bash
# Resubmit failed experiments: K=8, Flow Policy, Full Flow
# Previous batch had CUDA contention issues - now queue is empty so should work
...
echo "==========================================="
echo "Resubmitting Failed Experiments (400GB)"
echo "Time: $(date)"
echo "==========================================="
...
# =============================================
# Flow WM K=8 Euler (3 seeds) - previously failed
# =============================================
echo ""
...
# =============================================
# MLP WM + Flow Policy (3 seeds) - previously failed
# =============================================
echo ""
...
# =============================================
# Full Flow: Flow WM + Flow Policy (3 seeds) - previously failed
# =============================================
echo ""
