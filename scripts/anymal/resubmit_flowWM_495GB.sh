#!/bin/bash
# Resubmit Flow WM jobs with increased memory (495GB) to fix OOM
# Previous batch failed with OUT_OF_MEMORY
...
echo "==========================================="
echo "Resubmitting Flow WM Jobs with 495GB Memory"
echo "Time: $(date)"
echo "==========================================="
...
echo ""
echo "==========================================="
echo "All Flow WM jobs submitted with 495GB memory!"
