#!/bin/bash
# Resubmit failed flow jobs with fixed Hydra argument quoting
# Note: Baseline jobs (3080227-3080229) are already running successfully
# Note: Flow K=4 s123 (job 3076505) is still running from previous batch
...
echo "==========================================="
echo "Resubmitting Flow Jobs with Fixed Hydra Quoting"
...
# =============================================
# Submit Flow K=4 Heun (best default)
# =============================================
echo ""
...
# =============================================
# Submit Flow K=8 Euler (highest accuracy)
# =============================================
echo ""
...
echo ""
echo "==========================================="
echo "All flow jobs submitted!"
echo "Expected jobs: 8 (2 K=4 + 3 K=2 + 3 K=8)"
