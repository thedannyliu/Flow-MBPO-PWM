#!/bin/bash
#SBATCH --job-name=train_mt30_flow_v1
...
#SBATCH --qos=embers
#SBATCH --output=/storage/project/r-agarg35-0/nnguyen349/logs/train_mt30_flow_v1_%j.out
#SBATCH --error=/storage/project/r-agarg35-0/nnguyen349/logs/train_mt30_flow_v1_%j.err
...
echo ""
echo "============================================"
echo "Training Flow-MBPO V1 48M Multi-task (MT30)"
echo "============================================"
echo "Method: Flow-matching world model"
echo "Config: use_flow=true, heun integrator, 2 substeps"
echo "============================================"
...
#   flow_substeps=2: 2 integration substeps
#   exp_name=flowv1_48M_mt30: For wandb tracking
