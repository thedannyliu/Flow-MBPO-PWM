...
| 2026-05-28 | `rerun_g1_bc_expert_uniform_mlp50k_20260528` | `163a626` | `flow-mbpo-mjlab-bc-expert-uniform-20260528` | expert,expert_noisy QS windows | 0-2 | pending | submitted as Slurm jobs `9236994` H100 and fallback `9237030` A100, both `embers`, same manifest/output locks | `scripts/experiments/mjlab_qs/manifests/rerun_g1_bc_expert_uniform_mlp50k_20260528.csv` | Pending BC sampling ablation: uniform sampling versus prior quality-balanced expert BC. |
