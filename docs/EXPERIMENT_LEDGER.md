...
| 2026-05-28 | `rerun_g1_bc_expert_uniform_smooth1e2_mlp50k_20260528` | `4d4488e` | `flow-mbpo-mjlab-bc-expert-uniform-smooth-20260528` | expert,expert_noisy QS windows | 0-2 | pending | submitted as Slurm job `9237622`, `gpu-a100`, `embers`, array `0-2%1` | `scripts/experiments/mjlab_qs/manifests/rerun_g1_bc_expert_uniform_smooth1e2_mlp50k_20260528.csv` | Pending BC action-smoothness ablation against uniform BC. |
