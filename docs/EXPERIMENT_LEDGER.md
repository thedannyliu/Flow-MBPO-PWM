...
| 2026-05-28 | `rerun_g1_bc_expert_uniform_mlp50k_20260528` | `36026df` | `5d2r2s05`, `jy8ljfcj`, `dt69il6l` | expert,expert_noisy QS windows | 0-2 | final and best policy checkpoints | eval returns `36.2848`, `39.8943`, `61.9562`; eval lengths `487.15`, `535.67`, `766.70`; rollout job `9237329` pending | `scripts/experiments/mjlab_qs/manifests/rerun_g1_bc_expert_uniform_mlp50k_20260528.csv` | Uniform BC eval improves seed2 but needs rollout MP4/fall-rate evidence before conclusion. |
