...
| Full upstream PWM pipeline bridge | Smoke `9401871` completed 0:0 through `train_dflex.py` and upstream `pwm.algorithms.pwm.PWM`; longer diagnostic `9401906` completed 0:0, wrote best/final and iter50/100/150 checkpoints, and ended with poor internal eval length `35.33`; W&B-disabled final/best real-env eval smoke arrays `9401975` H200 and `9401980` H100 are pending. | Pipeline mechanically feasible, but no performance claim until final/best real-env eval smoke succeeds and formal eval40 plus rollout10 gates exist. |
