...
### Phase 8: WM Pretraining (Resubmitted)
**Method**: Pretrain WM From Scratch
| Job ID | WM Type | Config | Iters | Hardware | Status | Notes |
|--------|---------|--------|-------|----------|--------|-------|
| `4012915` | Flow WM | `pwm_48M_mt_flowwm` | 200k | H100 | ⏳ QUEUED | Fixed OmegaConf error |
| `4012916` | MLP WM | `pwm_48M_mt_baseline` | 200k | H100 | ⏳ QUEUED | Fixed OmegaConf error |

**Failed Runs (Fixed)**:
| Job ID | Status | Reason |
|--------|--------|--------|
| `4012664` | ❌ FAILED | ConfigAttributeError: `episode_length` not in struct |
| `4012665` | ❌ FAILED | Same as above |
...
| `4012601_19-26` | flow_high | All | * | H100 | ~60m | 🟢 RUNNING | - |
