...
| Conservative broad Flow-MBPO AWR sweep | `flow_mbpo_broad_embers_awr_20260602` plus H200/H100/L40S shards `9400410`, `9400436`, `9400435`, `9400525` | Flow endpoint / trajectory / residual synthetic replays, H1/H3/H5 | Conservative AWR with support/action penalty and CQL-style critic | seeds 0-1 diagnostic rows | Summaries under `scripts/outputs/mjlab_qs/flow_mbpo_broad_embers_awr_20260602/*/summary.json` and `scripts/outputs/mjlab_qs/flow_mbpo_broad_embers_awr_shards_20260602/{h200,h100,l40s}/*/summary.json`. | best 8-episode row `25.9699` | best length `367.00`; best score row length `360.00` | `1.000` for every completed row | Negative diagnostic. All rows remain below BC `45.8491` / `594.97` / `0.625`; do not expand this exact setting or treat it as a formal improvement candidate. |
...
Conservative broad Flow-MBPO AWR sweep: negative; every completed row falls in all 8 real-eval episodes
