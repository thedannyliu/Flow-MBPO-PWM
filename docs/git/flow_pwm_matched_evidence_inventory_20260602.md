...
| Flow-MBPO AWAC diagnostics | Endpoint H200 seed0 `9402229`, fixed-SHA H200 seed1 `9402337`, replay-family H200 `9402361`, old H100/L40S endpoint backups `9402277`/`9402278` | Flow endpoint, trajectory chunk, residual-flow, and MLP-reference synthetic replays | Critic-derived AWAC weights `Q(s,a_data)-Q(s,pi(s))` with conservative critic, mixed OOD actions, support action penalty, real-eval early stop | seed 0 and seed 1 diagnostic rows | Summaries/checkpoints under `scripts/outputs/mjlab_qs/flow_mbpo_awac_short_horizon_diag_20260602/`, `flow_mbpo_awac_fixedsha_seed1_h200_20260602/`, `flow_mbpo_awac_replay_family_seed0_h200_20260602/`, `flow_mbpo_awac_short_horizon_diag_h100_20260602/`, and `flow_mbpo_awac_short_horizon_diag_l40s_20260602/`. | H200 seed0 endpoint around `19.79`; H200 seed1 endpoint `8.51`-`8.95`; replay-family H200 `19.42`-`19.93`; H100/L40S endpoint around `19.06`-`19.98` | H200 seed0 endpoint around `297`; H200 seed1 endpoint `154`-`159`; replay-family H200 `291.75`-`298.125`; H100/L40S endpoint `277.125`-`298.375` | `1.000` for every completed row | Negative diagnostic. AWAC now mechanically runs across GPU nodes and replay families, but all completed rows fall at rate `1.000`, early-stop at iter 20, and fail the BC gate. Do not promote this AWAC setting to formal eval/video. |
